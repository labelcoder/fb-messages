    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item active">แก้ไขแคทตาล๊อตสินค้า</li>
            </ol>
            <div class="card mb-4 col-6">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    แก้ไขแคทตาล๊อตสินค้า
                </div>
                <div class="card-body">
                    <form class="row g-3" id="frm-save" method="post" action="{{ route('api.v1.categories.update') }}">
                        <input type="hidden" name="edit_id" value="{{$category->id}}">
                        <div class="col-md-12">
                            <label for="category_name" class="form-label">ชื่อแคทตาล๊อต</label>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="description" class="form-control" id="category_description" cols="30" rows="5">{!! $category->description !!}</textarea>
                        </div>

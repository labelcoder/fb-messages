    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4 col-8">
                ...
                <div class="card-body">
                    <form class="row g-3" id="frm-save" method="POST" action="{{ route('api.v1.products.store') }}">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="stock_quantity" class="form-control" id="stock_quantity" value="0">
                        </div>
                        <div class="col-md-12">
